...
public class MethodExampleView {
	...
	//클래스 내 어디서든 사용 가능한 스캐너 객체 생성 (캡슐화 원칙에 따라 private)
	...
	public void displayMenu() {
		...
		do {
			...
			case 2:
				//service.method2(10, 50, 30); 
				menu2(); //현재 객체가 가지고 있는 menu2() 메서드 호출 =this.menu2();
				break;
			case 3: 
				String result = service.method3(); //method3() 호출 후 String 값을 반환 받고 그 값을 result에 저장
		...
		}while(input!=0); //0이면 반복 종료
	}
	
	//정수 3개를 입력 받고 service.method2()를 호출하는 메서드
	public void menu2() {
