...
//		System.out.println(f.v2); //에러 protected 다른 패키지, 상속X
		System.out.println(v2); 
		//int edu.kh.oop.field.ex1.FieldTest.v2
		//상속 관계에서는 protected 직접 접근 가능
//		System.out.println(f.v3); //에러 (default) 다른 패키지
//		System.out.println(f.v4); //에러 private은 같은 클래스 내부에서만 접근 가능
	}
